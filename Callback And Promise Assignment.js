...
function doubleUsingCallback(array, callback) {
    ...
    for (const element of array) {
      const doubledElement = callback(element);
  ...
  const newArray = doubleUsingCallback(array, double);
...
function arrangeInAlphabeticalOrder(books, callback) {
  ...
  const logTitlesInAlphabeticalOrder = (titles) => {
...
function greetingPromise(name) {
  ...
  const greeting = greetingPromise("Mithun");
